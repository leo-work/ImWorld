...
void QNChatMessage::setText(QString text, QString time, QSize allSize, QNChatMessage::User_Type userType, QString leftImage, QString rightImage)
{
  
    m_leftPixmap = QPixmap(leftImage);
    m_rightPixmap = QPixmap(rightImage);
