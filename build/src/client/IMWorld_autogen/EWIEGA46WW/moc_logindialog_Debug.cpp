...
#include "../../../../../src/client/logindialog.h"
...
QT_MOC_LITERAL(1, 12, 16), // "sendLoginRequest"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 7), // "account"
QT_MOC_LITERAL(4, 38, 8) // "password"

    },
    "LoginDialog\0sendLoginRequest\0\0account\0"
    "password"
};
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendLoginRequest((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->sendLoginRequest(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginDialog::sendLoginRequest)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginDialog::sendLoginRequest(QString _t1, QString _t2)
{
